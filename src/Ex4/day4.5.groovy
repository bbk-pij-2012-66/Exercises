...
while (running) {
	...
	switch (option) {
		case 0:
			...
			break;
		case 1:
			println "...the answer is " + binary2decimal(stringNum) + "!";
			break;
		case 2:
			println "...the answer is " + decimal2binary(stringNum) + "!";
			break;
		default:
...
int binary2decimal (String stringNum) {
...
String decimal2binary (String stringNum) {
	println " to binary...";
